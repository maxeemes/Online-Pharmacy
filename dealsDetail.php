		...
		<div class="Main">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="deals.php">Сделки</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Заказ №<?php echo $_GET['red_id']; ?></li>
                </ol>
            </nav>
            <div class="Nav">
			</div>
